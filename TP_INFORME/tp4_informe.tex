...
\begin{titlepage}
    ...
    \begin{tabular}{ll}
        ...
        \textbf{Fecha de realización:} & \textit{Viernes 14 de Noviembre} \\
        \textbf{Fecha de entrega:} & \textit{Viernes 21 de Noviembre} \\
    \end{tabular}
    \vspace{2cm}
\end{titlepage}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{bobina.png}
    \caption{Bobina utilizada como elemento inductivo en el circuito serie R--L.}
    \label{fig:bobina}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{resistencia.png}
    \caption{Resistencia externa empleada como carga resistiva en el circuito.}
    \label{fig:resistencia}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{transformador_12_detalle.png}
    \caption{Detalle del transformador utilizado para alimentar la lámpara de baja tensión.}
    \label{fig:transformador}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{multimetros.png}
    \caption{Multímetros digitales empleados para medir tensiones y corrientes eficaces en las distintas configuraciones.}
    \label{fig:multimetros}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{cables_banana.png}
    \caption{Cables tipo banana utilizados para realizar las conexiones entre los elementos del circuito.}
    \label{fig:cables_banana}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{circuito.png}
    \caption{Montaje del circuito serie R--L con la fuente de CA, la resistencia y la bobina conectadas mediante cables tipo banana.}
...
El diagrama de fasores presentado en la Figura 7 muestra la relación vectorial entre las distintas tensiones del circuito. Se toma la corriente \(I\) como referencia (en el eje real), de modo que \(V_R\) y \(V_r\) aparecen también en el eje real (están en fase con la corriente). La tensión inductiva \(V_L = I \omega L\) aparece en el eje imaginario (adelantada \(90^\circ\) respecto de la corriente). La tensión total en la bobina \(V_{ZL}\) es la suma vectorial de \(V_r\) y \(V_L\), y la tensión de la fuente \(V_T\) es la suma vectorial de \(V_R\) y \(V_{ZL}\). El ángulo \(\varphi \approx 34{,}2^\circ\) representa el desfase entre la tensión total y la corriente, determinando un factor de potencia \(\cos\varphi \approx 0{,}83\).

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{diagrama_fasores.png}
    \caption{Diagrama de fasores del circuito serie R--L, mostrando las tensiones \(V_R\) (en resistencia externa), \(V_r\) (en resistencia interna de la bobina), \(V_L\) (componente inductiva), \(V_{ZL}\) (tensión total en la bobina) y \(V_T\) (tensión de la fuente). El ángulo \(\varphi\) indica el desfase entre tensión y corriente.}
    \label{fig:fasores}
\end{figure}
